package com.thinkgas.heatapp.ui.common.adapters
...
class ViewAttachmentAdapter(
    private val context: Context,
    var list: List<Attachment>,
    private val clickListener: (Attachment) -> Unit,
    private val deleteListener: (Attachment) -> Unit
): RecyclerView.Adapter<ViewAttachmentAdapter.AttachmentViewHolder>(){
    ...
    inner class AttachmentViewHolder(private val binding:PhotoListItemBinding):
            RecyclerView.ViewHolder(binding.root){
                ...
                fun bind(context: Context,
                         ...
                         deleteListener: (Attachment) -> Unit
                ){
                    binding.apply {
                        Glide.with(context)
                            .load(data.image)
    ...
    override fun onBindViewHolder(holder: AttachmentViewHolder, position: Int) {
        holder.bind(context,list[position],clickListener,deleteListener)
    }
