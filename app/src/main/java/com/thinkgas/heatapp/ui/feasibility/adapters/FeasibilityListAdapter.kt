package com.thinkgas.heatapp.ui.feasibility.adapters
...
class FeasibilityListAdapter(var context: Context,
    ...
    PagingDataAdapter<Agent, FeasibilityListAdapter.AgentViewHolder>(AgentDiffCallBack()) {

    inner class AgentViewHolder(
        private var binding: ServiceDetailListItemBinding
    ) : RecyclerView.ViewHolder(binding.root) {
        fun bind(context: Context, item: Agent?, clickListener: (Agent) -> Unit,
                 claimListener: (Agent) -> Unit,
...
//                tvAssignDate.text = item.claimedDate
    ...
    override fun onBindViewHolder(holder: AgentViewHolder, position: Int) {
        getItem(position)?.let { holder.bind(context, it, clickListener,claimListener,navigateListener,
            callListener,cancelListener,supervisorListener,infoListener) }
    }
