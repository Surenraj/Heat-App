package com.thinkgas.heatapp.ui.lmc.adapters
...
class LmcListAdapter(var context: Context,
    ...
    PagingDataAdapter<Agent, LmcListAdapter.AgentViewHolder>(AgentDiffCallBack()) {
    inner class AgentViewHolder(
        ...
        fun bind(context: Context,isClaimable: Boolean, item: Agent?, clickListener: (Agent) -> Unit,
                 infoListener: (Agent) -> Unit,claimListener: (Agent) -> Unit,navigateListener: (String, String) ->
            Unit,cancelListener: (Agent) -> Unit, supervisorListener: (Agent) -> Unit) {
            binding.apply {
...
//                    }
    ...
    override fun onBindViewHolder(holder: AgentViewHolder, position: Int) {
        getItem(position)?.let { holder.bind(context,isClaimable, it, clickListener,infoListener,
            claimListener,navigateListener,cancelListener,supervisorListener) }
    }
